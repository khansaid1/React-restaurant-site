...
import { topPicks } from '../Food materials/data/data';
      ...
      <Splide options={{perPage: 4, gap:"0.5rem", drag:'free', arrows:false}}>
      {
        topPicks.map((item)=>{
          return (
            ...
            <div className='round-3xl relative'>
              <div className='absolute w-full h-full bg-black/50 rounded-3xl text-white'
               ...
               <img className='h-[200px] w-full object-cover rounded-3xl cursor-pointer hover:scale-104 ease-out duration 300'
                src={item.img}
                alt={item.title}
                />
            </div>
